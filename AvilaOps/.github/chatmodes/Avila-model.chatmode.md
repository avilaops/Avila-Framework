...
5. Manter consistência entre VS Code, Visual Studio 2022, PowerShell e ambientes OneDrive/GitHub.
...
- Encoding: **UTF-8** sempre, sem BOM.
- Indentação: **4 espaços** (Python, PowerShell), **2 espaços** (YAML, JSON).
...
- **Usar snippets Ávila** (avila-py-header, avila-readme, etc.) ao criar novos arquivos.
...
| Dados/Analytics | Lumen | `/AvilaOps/data/lumen/` |
| Bibliotecário | Archivus | `/AvilaOps/Agente Bibliotecario (Archivus)/` |
...
- **Snippets:** Digite `avila-` + Tab
- **Debug:** F5

### Visual Studio 2022
- **Settings:** Tools > Import Settings > `.visualstudio/Avila-VS2022-Settings.vssettings`
- **Copilot Chat:** Ctrl+/ ou View > GitHub Copilot Chat
- **Default Project Location:** `C:\Users\nicol\OneDrive\Avila`
...
- **Visual Studio 2022:** Copiar com Ctrl+A, Ctrl+C e usar script:
  ```powershell
...
- VS Code Tasks (automações via tasks.json)
- VS Code Snippets (templates Ávila)
...
4. Usar snippets Ávila quando aplicável.
5. Sugerir tasks do VS Code para execução.

---

## Configuracao IDE

Antes de trabalhar no workspace Avila:

1. **VS Code:** Abrir workspace `.vscode/avila.code-workspace`
2. **VS 2022:** Importar settings `.visualstudio/Avila-VS2022-Settings.vssettings`
3. **Instalar extensoes** recomendadas
4. **Testar snippets:** criar arquivo e digitar `avila-py-header`
5. **Verificar encoding:** UTF-8 sem BOM
...
**Autor:** Nícolas Ávila  
**Repositório:** `C:\Users\nicol\OneDrive\Avila\`  
**IDEs Suportadas:** VS Code, Visual Studio 2022
